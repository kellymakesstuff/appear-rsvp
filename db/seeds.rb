...
# {first_name:'Tim', surname:'Beckam', attending:true, under10:true, phone:nil, email:'', household:@beckam.id},
# {first_name:'Mary', surname:'Giordana', attending:false, under10:true, phone:nil, email:'', household:@giordana.id},
# {first_name:'Tina', surname:'Johnson', attending:true, under10:true, phone:nil, email:'', household:@johnson.id},
# {first_name:'Anju', surname:'Wakamatsu', attending:true, under10:true, phone:nil, email:'', household:@wakamatsu.id},
# {first_name:'Gregory', surname:'Johnson', attending:false, under10:true, phone:nil, email:'', household:@johnson.id}])
