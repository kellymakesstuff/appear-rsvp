...
Photo.create!(src:"https://raw.githubusercontent.com/kellymakesstuff/appear-rsvp/dev/client/src/components/images/mock_photos/jackie_lila.JPG", width:4, height:3, household_id:@mirelda.id)
Photo.create!(src:"https://raw.githubusercontent.com/kellymakesstuff/appear-rsvp/dev/client/src/components/images/mock_photos/jackie_dara.JPG", width:4, height:3, household_id:@assam.id)
Photo.create!(src:"https://raw.githubusercontent.com/kellymakesstuff/appear-rsvp/dev/client/src/components/images/mock_photos/jackie_shelly.JPEG", width:4, height:3, household_id:@beckam.id)
Photo.create!(src:"https://raw.githubusercontent.com/kellymakesstuff/appear-rsvp/dev/client/src/components/images/mock_photos/all_monique.JPG", width:4, height:3, household_id:@beckam.id)
Photo.create!(src:"https://raw.githubusercontent.com/kellymakesstuff/appear-rsvp/dev/client/src/components/images/mock_photos/jackie_wendy.JPG", width:4, height:3, household_id:@giordana.id)
Photo.create!(src:"https://raw.githubusercontent.com/kellymakesstuff/appear-rsvp/dev/client/src/components/images/mock_photos/jackie_lena.JPG", width:4, height:3, household_id:@wakamatsu.id)
Photo.create!(src:"https://raw.githubusercontent.com/kellymakesstuff/appear-rsvp/dev/client/src/components/images/mock_photos/wilson_bob.JPG", width:4, height:3, household_id:@alvarez.id)
Photo.create!(src:"https://raw.githubusercontent.com/kellymakesstuff/appear-rsvp/dev/client/src/components/images/mock_photos/wilson_frank.JPG", width:4, height:3, household_id:@leed.id)
Photo.create!(src:"https://raw.githubusercontent.com/kellymakesstuff/appear-rsvp/dev/client/src/components/images/mock_photos/wilson_jake.JPG", width:4, height:3, household_id:@mirelda.id)
Photo.create!(src:"https://raw.githubusercontent.com/kellymakesstuff/appear-rsvp/dev/client/src/components/images/mock_photos/wilson_jason.JPG", width:4, height:3, household_id:@liu.id)
Photo.create!(src:"https://raw.githubusercontent.com/kellymakesstuff/appear-rsvp/dev/client/src/components/images/mock_photos/wilson_mike.JPG", width:4, height:3, household_id:@johnson.id)